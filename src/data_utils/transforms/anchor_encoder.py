...
from .box_utils import bbox_ltrb_to_center, bbox_center_to_ltrb, bbox_ltrb_to_ltwh
...
class AnchorEncoder(object):
    ...
    def __init__(self, anchors):
        ...
        self.anchors_xywh = to_cuda(anchors(order="xywh").unsqueeze(dim=0))
    ...
    def encode(self, bboxes_in: torch.Tensor, labels_in: torch.Tensor, iou_threshold: float):
        ...
        bboxes_out = bbox_ltrb_to_center(bboxes_out)
    ...
    def decode_output(self, bbox_delta: torch.Tensor, confs_in: Optional[torch.Tensor]):
        ...
        boxes_ltrb = bbox_center_to_ltrb(bbox_delta)
